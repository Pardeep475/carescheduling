...
public class ClientInfoSummaryViewModel  extends AndroidViewModel {
    ...
    public LiveData<ClientCareSummaryBean> getDisabilities(String customerId, String branchId, String clientId) {
        final MutableLiveData<ClientCareSummaryBean> data = new MutableLiveData<>();
        try {
