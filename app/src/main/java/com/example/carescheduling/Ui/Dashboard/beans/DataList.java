...
public class DataList{
  ...
  @Expose
  private List<com.example.carescheduling.Ui.Common.ClientBarcodeList> ClientBarcodeList;
  ...
  @Expose
  private List<com.example.carescheduling.Ui.Common.ClientNFCList> ClientNFCList;
