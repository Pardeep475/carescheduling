 ...
 */
@Entity
public class ScheduleClients implements Comparable {
    ...
    public int compareTo(Object o) {
        ...
        int compareage = Integer.parseInt(((ScheduleClients) o).getWeekRotationTypeName());
        /* For Ascending order*/
        return Integer.parseInt(this.getWeekRotationTypeName()) - compareage;
    }
}