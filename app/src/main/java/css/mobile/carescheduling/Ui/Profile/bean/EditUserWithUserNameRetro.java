...
public class EditUserWithUserNameRetro {
    private String BranchId,CustomerId,PasswordQuestion,PasswordQuestionAnswer,PersonId,UserName;
    ...
    public void setPasswordQuestionAnswer(String passwordQuestionAnswer) {
        PasswordQuestionAnswer = passwordQuestionAnswer;
    }
