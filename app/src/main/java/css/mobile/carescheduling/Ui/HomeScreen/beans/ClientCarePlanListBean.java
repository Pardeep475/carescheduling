...
public class ClientCarePlanListBean {
    ...
    public class Data {
        ...
        @Expose
        private List<ScheduleClientList> scheduleClientList = null;
        ...
        public List<ScheduleClientList> getScheduleClientList() {
            return scheduleClientList;
        }

        public void setScheduleClientList(List<ScheduleClientList> scheduleClientList) {
